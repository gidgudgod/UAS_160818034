...
@section('content')
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    <td data-th="Product">
                        <div class="row">
                            <div class="col-sm-3 hidden-xs"><img src="{{ asset('uploads/books/'.$details['photo']) }}" width="100" height="100" alt="{{$details['photo']}}"
        ...
        <tr>
            ...
            <td class="hidden-xs"><a href="{{ url('/submit_checkout') }}" class="btn btn-danger"> Finish
